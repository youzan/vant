...
module.exports = {
    ...
    docs: {
        ...
        components: [
            ...
            { group: 'Container', show: false, name: 'iframe', alias: 'Iframe', vusion: true },
            ...
            { group: 'Data', show: true, name: 'list-view', alias: '数据列表', vusion: true },
            { group: 'Data', show: true, name: 'for-components', alias: '组件列表' },
            { group: 'Data', show: true, name: 'grid-view', alias: '数据网格', vusion: true },
            ...
            { group: 'Form', show: true, name: 'stepper', alias: '数字输入' },

...
🚀 性能极佳，组件平均体积小于 1KB（min+gzip） 🚀 65+ 个高质量组件，覆盖移动端主流场景 💪 使用 TypeScript 编写，提供完整的类型定义 💪 单元测试覆盖率超过 90%，提供稳定性保障 📖 提供完善的中英文文档和组件示例 📖 提供 Sketch 和 Axure 设计资源 🍭 支持 Vue 2、Vue 3 和微信小程序 🍭 支持主题定制，内置 700+ 个主题变量 🍭 支持按需引入和 Tree Shaking 🍭 支持服务器端渲染 🌍 支持国际化和语言包定制

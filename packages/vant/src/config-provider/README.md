...
You can set `theme-vars-scope` to `global`. In this case, the CSS variables generated by `themeVars` will be applied to the root node of the HTML and take effect on all components within the entire page.

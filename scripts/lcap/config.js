module.exports = [
    ...
    { group: 'Display', show: true, name: 'cell-group', alias: '单元格' },
    { group: 'Display', show: true, name: 'popup', alias: '弹窗' },
    { group: 'Layout', show: true, name: 'row', alias: '栅格' },
    { group: 'Display', show: true, name: 'swipe', alias: '轮播' },
    { group: 'Selector', show: true, name: 'tabs', alias: '选项卡' },
    ...
    // { group: 'Form', show: true, name: 'u-radios', alias: '单选组' },
    // { group: 'Form', show: true, name: 'u-switch', alias: '开关' },

...
import { noopFormatter } from './Formatter';
import { placeholderFormatter } from './PlaceholderFormatter';
import { dateFormatter } from './DateFormatter';
import { numberFormatter } from './NumberFormatter';

const registedFormatters = {
    noop: noopFormatter,
...
export function parseFormatters(exp) {
    const expression = _parseFormatters('$$VALUE$$ | ' + exp);
    const _f = (name) => registedFormatters[name].format;

  ...
  render() {
    return (
      <svg width="160" height="160" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <linearGradient x1="64.022%" y1="100%" x2="64.022%" y2="0%" id="c">
            <stop stop-color="#FFF" stop-opacity=".5" offset="0%" />
            <stop stop-color="#F2F3F5" offset="100%" />
          </linearGradient>
          <linearGradient x1="64.022%" y1="96.956%" x2="64.022%" y2="0%" id="d">
            <stop stop-color="#F2F3F5" stop-opacity=".3" offset="0%" />
            <stop stop-color="#F2F3F5" offset="100%" />
          </linearGradient>
          <linearGradient x1="64.022%" y1="96.956%" x2="64.022%" y2="0%" id="e">
            <stop stop-color="#F2F3F5" stop-opacity=".3" offset="0%" />
            <stop stop-color="#F2F3F5" offset="100%" />
          </linearGradient>
          <linearGradient x1="64.022%" y1="100%" x2="64.022%" y2="0%" id="f">
            <stop stop-color="#FFF" stop-opacity=".5" offset="0%" />
            <stop stop-color="#F2F3F5" offset="100%" />
          </linearGradient>
          <linearGradient x1="50%" y1="0%" x2="50%" y2="84.459%" id="h">
            <stop stop-color="#EBEDF0" offset="0%" />
            <stop stop-color="#DCDEE0" stop-opacity="0" offset="100%" />
          </linearGradient>
          <linearGradient x1="100%" y1="0%" x2="100%" y2="100%" id="i">
            <stop stop-color="#EAEDF1" offset="0%" />
            <stop stop-color="#DCDEE0" offset="100%" />
          </linearGradient>
          <linearGradient x1="100%" y1="0%" x2="100%" y2="100%" id="j">
            <stop stop-color="#EAEDF1" offset="0%" />
            <stop stop-color="#DCDEE0" offset="100%" />
          </linearGradient>
          <linearGradient x1="100%" y1="100%" x2="100%" y2="0%" id="k">
            <stop stop-color="#EAEDF1" offset="0%" />
            <stop stop-color="#DCDEE0" offset="100%" />
          </linearGradient>
          <linearGradient x1="100%" y1="100%" x2="100%" y2="0%" id="l">
            <stop stop-color="#EAEDF1" offset="0%" />
            <stop stop-color="#DCDEE0" offset="100%" />
          </linearGradient>
          <linearGradient x1="0%" y1="43.982%" x2="100%" y2="54.703%" id="m">
            <stop stop-color="#EAEDF1" offset="0%" />
            <stop stop-color="#DCDEE0" offset="100%" />
          </linearGradient>
          <linearGradient
